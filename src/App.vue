  ...
  <div v-if="$route.name !== 'Login'" class="min-h-screen flex flex-col font-sans bg-white text-slate-900">
    ...
    <header class="h-16 bg-emerald-950 text-white flex items-center px-8 sticky top-0 z-50 shadow-sm">
      ...
      <div class="flex items-center gap-3 mr-12">
        <router-link to="/">
          <img :src="logo" class="h-9 w-auto object-contain cursor-pointer" alt="VSHold">
        </router-link>
        <router-link to="/" class="text-3xl font-bold tracking-tighter cursor-pointer">VSHold</router-link>
      </div>
      ...
      <nav class="flex items-center gap-8 text-sm font-medium flex-1">
        ...
        <div class="relative group">
          <router-link to="/company/history" class="hover:text-emerald-300 transition-colors py-2">Компания</router-link>
        ...
        <!-- Партнёрам -->
        <div class="relative group">
          <router-link to="/partners/suppliers" class="hover:text-emerald-300 transition-colors py-2">Партнёрам</router-link>
        ...
        <div class="relative group">
          <router-link to="/investors/reports" class="hover:text-emerald-300 transition-colors py-2">Акционерам и инвесторам</router-link>
        ...
        <!-- Пресс-центр -->
        <div class="relative group">
          <router-link to="/press/releases" class="hover:text-emerald-300 transition-colors py-2">Пресс-центр</router-link>
          <div class="absolute top-16 left-0 invisible opacity-0 group-hover:visible group-hover:opacity-100 bg-white text-slate-900 shadow-2xl rounded-3xl py-8 px-8 w-[520px] z-50 transition-all duration-200">
            <div class="space-y-3">
